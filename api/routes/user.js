...
const validatePersonalInfo = [
  ...
  body("phoneNumber").custom((value, { req }) => {
    ...
    const regex = /^92\d{10}$/;
    if (!regex.test(value)) {
      return Promise.reject("Phone Number should be in the format 92xxxxxxxxxx");
    }
    return true;
  }),
  ...
  body("personalInfo.alternativePhoneNumber").custom((value, { req }) => {
    ...
    const regex = /^92\d{10}$/;
    if (!regex.test(value)) {
      return Promise.reject("Alternative Phone Number should be in the format 92xxxxxxxxxx");
    }
    return true;
  }),
...
const validateFamilyDetails = [
  ...
  body("familyDetails.residentialPhoneNumber").custom((value, { req }) => {
    ...
    const regex = /^92\d{10}$/;
    if (!regex.test(value)) {
      return Promise.reject("Residential Phone Number should be in the format 92xxxxxxxxxx");
    }
    return true;
  }),
  body("familyDetails.officePhoneNumber").custom((value, { req }) => {
    ...
    const regex = /^92\d{10}$/;
    if (!regex.test(value)) {
      return Promise.reject("Office Phone Number should be in the format 92xxxxxxxxxx");
    }
    return true;
  }),
  body("familyDetails.monetaryAssistanceAmount").custom((value, { req }) => {
    ...
    const regex = /^[0-9]+$/;
    if (!regex.test(value)) {
      return Promise.reject("Monetary Assistance Amount should contain only numbers");
    }
    return true;
  }),
  ...
  body("familyDetails.totalFamilyIncome").custom((value, { req }) => {
    ...
    const regex = /^[0-9]+$/;
    if (!regex.test(value)) {
      return Promise.reject("Total Family Income should contain only numbers");
    }
    return true;
  }),
  body("familyDetails.totalNoOfDepandants").custom((value, { req }) => {
    ...
    const regex = /^[0-9]+$/;
    if (!regex.test(value)) {
      return Promise.reject("Total No. of Dependants should contain only numbers");
    }
    return true;
  }),  
];
...
const validateEducationDetails = [
  ...
  body("educationData.obtainedMarksCGPA").custom((value, { req }) => {
    ...
    const regex = /^[0-9]+$/;
    if (!regex.test(value)) {
      return Promise.reject("Obtained Marks/CGPA should contain only numbers");
    }
    return true;
  }),
